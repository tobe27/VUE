            ...
            <Form ref="form" :model="form" :rules="ruleValidate" :label-width="130">
              <div class="divpage">
                ...
                <Row>
                  ...
                  <Col span="8">
                    <FormItem label="客户类型" prop="type">
                      <Input v-model="form.type" placeholder="请输入客户类型"></Input>
                    </FormItem>
                  </Col>
                  <Col span="8">
                  ...
                  <Col span="8">
                    <FormItem label="证件号码" prop="idNumber">
                      <Input
                        ...
                        placeholder="请输入15或18位有效证件号码"
                        @on-blur="selectResidentByIdNumber(form.idNumber)"
                      ></Input>
                    </FormItem>
                  </Col>
                  <Col span="8">
                    <FormItem label="签发机构" prop="type">
                      <Input v-model="form.type" placeholder="请输入签发机构"></Input>
                    </FormItem>
                  </Col>
                </Row>
                <Row>
                  <Col span="8" v-if="form.isFarmer=='是'">
                    <FormItem label="是否长期" prop="isBuyHouse">
                      <Select v-model="form.isBuyHouse" placeholder="是否长期">
                  ...
                  <Col span="8">
                    <FormItem label="签发日期" prop="birthday">
                      <DatePicker type="date" placeholder="请选择签发日期" v-model="form.birthday"></DatePicker>
                    </FormItem>
                  </Col>
                  <Col span="8">
                    <FormItem label="到期日期" prop="birthday">
                      <DatePicker type="date" placeholder="请选择到期日期" v-model="form.birthday"></DatePicker>
                    </FormItem>
                  </Col>
                </Row>
                <Row>
                  ...
                  <Col span="16">
                    <FormItem label="片区地址" prop="companyAddress">
                      <Input v-model="form.companyAddress" :maxlength="100" placeholder="请输入片区地址"></Input>
                    </FormItem>
                  </Col>
                </Row>
                <Row>
                  <Col span="8">
                    <FormItem label="邮政编码" prop="postcode">
                      <Input v-model="form.postcode" placeholder="请输入邮政编码"></Input>
                    </FormItem>
                  </Col>
                  <Col span="16">
                    <FormItem label="详细住址" prop="companyAddress">
                      <Input v-model="form.companyAddress" :maxlength="100" placeholder="请输入详细住址"></Input>
                    </FormItem>
                  </Col>
                </Row>
                <Row>
                  ...
                  <Col span="16" v-if="form.isBuyHouse=='是' && form.isFarmer=='是'">
                    <FormItem label="户籍地址" prop="cellAddress">
                      <Input v-model="form.cellAddress" :maxlength="100" placeholder="请输入户籍地址"></Input>
                    </FormItem>
                  </Col>
                </Row>
                <Row>
                  ...
                  <Col span="8">
                    <FormItem label="最高学历" prop="educationLevel">
                      <Select v-model="form.educationLevel" placeholder="请选择最高学历">
                ...
                <Row>
                  <Col span="8">
                    <FormItem label="配偶姓名">
                      <Input v-model="form.companyName" placeholder="请输入配偶姓名"></Input>
                    </FormItem>
                  </Col>
                  <Col span="8">
                    <FormItem label="配偶身份证号">
                      <Input v-model="form.companyName" placeholder="请输入配偶身份证号"></Input>
                    </FormItem>
                  </Col>
                  <Col span="8">
                    <FormItem label="配偶电话">
                      <Input v-model="form.companyName" placeholder="请输入配偶电话"></Input>
                    </FormItem>
                  </Col>
                </Row>
                <Row>
                  <Col span="16">
                    <FormItem label="配偶工作单位">
                      <Input v-model="form.companyName" placeholder="请输入配偶工作单位"></Input>
                    </FormItem>
                  </Col>
                </Row>
              </div>
                ...
                <Row>
                  <Col span="8">
                    <FormItem label="是否农户" prop="isFarmer">
                      <Select
                        v-model="form.isFarmer"
                        placeholder="请选择是否农户"
                        @on-change="changeBorrowerNature"
                      >
                        <Option value="是">是</Option>
                        <Option value="否">否</Option>
                      </Select>
                ...
                <Row>
                  <Col span="16">
                    <FormItem label="社会评价(村委会)" prop="socialEvaluation">
                      <Input
                        v-model="FLform.socialEvaluation"
                        type="textarea"
                        :autosize="{minRows: 2,maxRows: 5}"
                        placeholder="请输入社会评价(村委会评价)"
                      ></Input>
                    </FormItem>
                  </Col>
                </Row>
              ...
              <div class="divpage">
                <div style="margin-bottom:30px;">
                  <Button
                    ...
                    type="primary"
                    :to="'/customer/addDetail?householdId='+householdId+'&customerId='+form.customerId"
                    icon="ios-add"
                  >新建</Button>
                </div>
                <div class="table">
                ...
                <Modal v-model="deleteFamilyModel.show" footer-hide width="320">
                  ...
                  <div style="text-align: right">
                    ...
                    <Button
                      type="primary"
                      size="large"
                      :loading="deleteFamilyModel.loading"
                      @click="deleteFMUser"
                    >确定</Button>
                  </div>
                </Modal>
                ...
                <div class="tagright">
                  <CheckboxGroup v-model="tag">
                    <Checkbox
                      ...
                      :key="index"
                      :label="item.tagId"
                      :disabled="item.tagName == '黑名单'||item.tagName == '白名单'||item.tagName == '灰名单'||item.tagName == '授信客户'"
          ...
          <div class="tabsForm">
                ...
                <div class="demo-upload-list" v-for="(image,imgIndex) in h.list" :key="imgIndex">
                  ...
                  <div class="demo-upload-list-cover">
                    <Icon
                      ...
                      @click.native="handleView(imgIndex,index)"
                      size="50"
                    ></Icon>
            ...
            <Modal v-model="addImageModal" title="附件上传" width="400px" :footer-hide="true">
              ...
              <div style="margin-bottom: 15px;margin-top: 15px;">
                <Select
                  v-model="imageType.upload.type"
                  placeholder="请选择影像类型"
                  v-show="imageType.show"
                >
                  <Option
                    v-for="(h, index) in imageType.types"
                    :key="index"
                    :value="h.type"
                  >{{ h.name }}</Option>
                </Select>
            ...
            <Modal v-model="deleteImageModel.show" footer-hide width="320" :closable="false">
              ...
              <div style="text-align: right">
                ...
                <Button
                  type="primary"
                  size="large"
                  :loading="deleteImageModel.loading"
      ...
      FDruleValidate: {
        ...
        housePrice: [
          { required: false, message: "", trigger: "change" },
          {
            type: "string",
            pattern:
              "(^[1-9]([0-9]{0,15})?(\\.\\d{1,2})?$)|(^0$)|(^\\d\\.\\d{1,2}$)",
            message: "长度为1~18位,可保留2位小数",
            trigger: "blur"
          }
        ],
        houseNumber: [
  ...
  methods: {
      ...
      return this.$store.dispatch(actions.get.CUSTOMER_PERSON, id).then(rep => {
        if (rep.code === 200) {
          ...
          if (vue.form.birthday) {
            vue.form.birthday =
              vue.form.birthday.substring(0, 4) +
              "-" +
              vue.form.birthday.substring(4, 6) +
              "-" +
              vue.form.birthday.substring(6);
          }
    ...
    handleSubmit(name) {
      ...
      this.$refs[name].validate(valid => {
        if (valid) {
          ...
          payload.birthday = `${date.getFullYear()}${
          ...
          if ("customerId" in payload) {
            ...
            this.$store
              .dispatch(actions.put.CUSTOMER_PERSON, payload)
              .then(rep => {
            ...
            this.$store
              .dispatch(actions.post.CUSTOMER_PERSON, payload)
              .then(rep => {
                if (rep.data.code === 200) {
    ...
    temporarySubmit(name) {
      ...
      if ("customerId" in payload) {
        ...
        delete payload.updatedAt;
        this.$store
          .dispatch(actions.put.TEMPORARY_PERSON, payload)
          .then(rep => {
            if (rep.data.code === 200) {
        ...
        this.$store
          .dispatch(actions.post.TEMPORARY_PERSON, payload)
          .then(rep => {
            if (rep.data.code === 200) {
    ...
    getFLupdate(householdId) {
      var vue = this;
      this.$store
        .dispatch(actions.get.RESIDENT_USER_ROLEID, { roleId: 1 })
        .then(rep => {
          if (rep.code === 200) {
      ...
      this.$store
        .dispatch(actions.get.FAMILYS_PERSON, vue.form.householdId)
        .then(rep => {
          if (rep.code === 200) {
            if (rep.data) {
              vue.FLform = { ...rep.data };
    ...
    FLhandleSubmit(name) {
      ...
      this.$refs[name].validate(valid => {
        if (valid) {
          ...
          payload.insuranceType = insuranceTypeNew.slice(
            0,
            insuranceTypeNew.length - 1
          );
          if ("familyId" in payload) {
            vue.$store
              .dispatch(actions.put.FAMILYS_PERSON, payload)
              .then(rep => {
                if (rep.data.code === 200) {
            ...
            vue.$store
              .dispatch(actions.post.FAMILYS_PERSON, payload)
              .then(rep => {
                if (rep.data.code === 200) {
                  if ("customerId" in this.$route.query) {
    ...
    getFMupdate(customerId) {
      var vue = this;
      return this.$store
        .dispatch(actions.get.MEMBER_LIST, customerId)
        .then(rep => {
          if (rep.code === 200) {
    ...
    deleteFMUser() {
      ...
      var vue = this;
      this.$store
        .dispatch(actions.delete.MEMBER_PERSON, this.deleteFamilyModel.memberId)
        .then(rep => {
          if (rep.data.code === 200) {
      ...
      this.$refs[name].validate(valid => {
        if (valid) {
          ...
          if ("financeId" in payload) {
            vue.$store
              .dispatch(actions.put.PROPERTY_PERSON, payload)
              .then(rep => {
                if (rep.data.code === 200) {
            ...
            vue.$store
              .dispatch(actions.post.PROPERTY_PERSON, payload)
              .then(rep => {
                if (rep.data.code === 200) {
    ...
    getMyTag(idNumber) {
      ...
      vue.tag = [];
      return this.$store
        .dispatch(actions.get.MYTAG_LIST, idNumber)
        .then(rep => {
          if (rep.code === 200) {
    ...
    submitTag() {
      ...
      var vue = this;
      this.$store
        .dispatch(actions.post.MYTAG_PERSON, {
    ...
    tagdelete() {
      ...
      vue.$store
        .dispatch(actions.delete.MYTAG_PERSON, {
    ...
    getImageList(index) {
      var vue = this;
      this.$store
        .dispatch(actions.get.IMAGE_LIST, {
          idNumber: vue.form.idNumber,
    ...
    deleteImageUser() {
      ...
      var vue = this;
      this.$store
        .dispatch(actions.delete.IMAGE_PERSON, this.deleteImageModel.id)
        .then(rep => {
          vue.deleteImageModel.loading = false;
    ...
    selectResidentByIdNumber(idNumber) {
      ...
      if (!("customerId" in this.$route.query)) {
        // 新建客户信息时调用
        this.$store
          .dispatch(actions.get.RESIDENTBYIDNUMBER_PERSON, idNumber)
          .then(rep => {
            if (rep.code === 200) {
              let data = { ...rep.data };
              vue.form = {
